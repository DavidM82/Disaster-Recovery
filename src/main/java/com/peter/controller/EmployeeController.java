...
import com.peter.bean.EmployeeBean;
import com.peter.model.Employee;
import com.peter.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView listEmployees() {
		...
		return new ModelAndView("employeesList", model); // logical name of view, logical name of model, actual model
	}
	...
	private List<EmployeeBean> prepareListofBean(List<Employee> employees){
		...
		if(employees != null && !employees.isEmpty()){
			...
			for(Employee employee : employees){
				...
				beans.add(bean);          //  How are two related.
			}
		}
		return beans;
	}
