...
<html>
	...
	<body>
		...
		<form:form method="POST" action="save.html">
	   		<table>
			    <tr>
			        <td><form:label path="id">Country ID:</form:label></td>
			    ...
			    <tr>
			        <td><form:label path="age">Country Population:</form:label></td>
			        <td><form:input path="age" value="${employee.age}"/></td>
			    </tr>
			    <tr>
			        <td><form:label path="salary">Country GDP:</form:label></td>
			        <td><form:input path="salary" value="${employee.salary}"/></td>
			    </tr>
			    
			    <tr>
			        <td><form:label path="address">Country Location:</form:label></td>
